...
--vcom -2008 ../src/mux2v1.vhd                         --Already done above
...
vcom -2008 ../src/register_32.vhd
vcom -2008 ../src/decodeur_instructions.vhd
vcom -2008 ../src/unite_controle.vhd
...
-- Afficheur :
add wave -radix hex -label Afficheur /processeur_tb/Afficheur
